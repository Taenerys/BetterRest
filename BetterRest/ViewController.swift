...
//  BetterRest
//
//  Created by Pham Ha Thu Anh on 2020/06/25.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        coffeeTitle.text = "How many cups of coffee do you drink each day?"
    ...
    @objc func calculateBedTime() {
        ...
        do {
            ...
            title = "Error"
            message = "Sorry. There was a problem of calculating your bedtime."
        }
